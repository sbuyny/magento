...
use SergiiBuinii\PartnerFeed\Filesystem\Io\FtpFactory;
...
class FtpAdapter
{
    ...
    /**
     * @var \SergiiBuinii\PartnerFeed\Filesystem\Io\Ftp
     */
    ...
    /**
     * @var \SergiiBuinii\PartnerFeed\Filesystem\Io\FtpFactory
     */
     ...
     * @param \SergiiBuinii\PartnerFeed\Filesystem\Io\FtpFactory $adapterFactory
     */
    public function __construct(
        ConfigHelper $configHelper,
        FtpFactory $adapterFactory
    ) {
     ...
     * Retrieve connection
     *
     * @return \SergiiBuinii\PartnerFeed\Filesystem\Io\Ftp
     */
    ...
    /**
     * Create connection to an FTP server using specified configuration
     *
     * @return \SergiiBuinii\PartnerFeed\Filesystem\Io\Ftp
     * @throws \Exception
     */
    public function createConnection()
    {
        ...
        /** @var \SergiiBuinii\PartnerFeed\Filesystem\Io\Ftp $connection */
    ...
    public function upload($filename, $content)
    {
        if (!$this->getConnection()->write($filename, $content)) {
            throw new \Exception(__(
                ...
                $this->getConnection()->getLastError()
            ));
        };
